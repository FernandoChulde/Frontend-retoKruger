...
export class AdministratorComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //   txtId: [this.information?.id],
    //   txtIdentification: [this.information?.identification],
    //   txtName: [this.information?.name],
    //   txtLastname: [this.information?.lastname],
    //   txtMail: [this.information?.mail],
    //   txtaddress: [this.information?.address],
    //   txtdateBirth: [this.information?.dateBirth],
    //   txtcellphone: [this.information?.cellphone],
    //   txtvaccinestatus: [this.information?.vaccinestatus],
    //   txtvaccinename: [this.information?.vaccinename],
    //   txtvaccinedate: [this.information?.vaccinedate],
    //   txtvaccinedose: [this.information?.vaccinedose],
    //   txtuser: [this.information?.user],
    //   txtpassword: [this.information?.password],
    ...
    this.service.create(
      {
        ...
        emp_user: this.form.value.txtMail,
        emp_password: this.form.value.txtIdentification
      }
    ).subscribe({
      next: rest => {
        this.employee.push(
  ...
  // method to save search words
  onSearchVaccineStatus( search: string ) {
    this.searchState = search;
    console.log(this.searchState);
    
  }
  // method to save search words
  onSearchVaccineName( search: string ) {
